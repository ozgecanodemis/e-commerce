...
const ProductPage = ({ limit, page }) => {
    ...
    // 414px'den küçükse sadece ilk 4 ürünü al
    ...
    return (
        <div className="p-4">
            <div className="w-full max-w-md flex flex-col justify-center items-center text-center mx-auto mb-6">
                <h6 className="text-[20px] font-[400] text-[#737373] leading-[30px] tracking-[0.2px] font-montserrat mb-4">
                    Featured Products
                </h6>
                <h1 className="text-[24px] font-[700] text-[#252B42] leading-[32px] tracking-[0.1px] font-montserrat mb-4">
                    BESTSELLER PRODUCTS
                </h1>
                <p className="text-[14px] font-[400] text-[#737373] leading-[20px] tracking-[0.2px] font-montserrat">
