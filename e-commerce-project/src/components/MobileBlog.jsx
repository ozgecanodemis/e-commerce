    ...
    return (
        <section className="p-4 flex flex-col items-center gap-[30px]">
            ...
            <div className="flex flex-col justify-center items-center mb-8">
                ...
                <p className="text-[14px] w-[263px] font-[400] text-[#737373] text-center font-montserrat mb-4 mobile:text-[12px] mobile:w-[90%]">
                    Problems trying to resolve the conflict between
                </p>
                <div className="flex flex-col justify-center items-center gap-[25px] mobile:gap-[15px]">
                    <button className="button-4">BUY NOW</button>
                    <button className="button-4">Learn More</button>

                </div>
                <img src={neural} alt="Neural Universe" className="w-full h-auto mb-8 mobile:max-w-[414px]" />
            </div>
